...
class MyViewBuilder: ViewBuilder1 {
    ...
    func buildTitle1BlueTextFavorites(isInFavorites: Bool, shouldShowOverlay: Bool, allViewIdentifiersTitle: String, allViewIdentifiers: String, context: ViewContext) -> some View {
