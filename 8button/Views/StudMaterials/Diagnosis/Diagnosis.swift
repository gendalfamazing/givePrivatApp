...
struct Diagnosis: View {
    ...
    var body: some View {
            ScrollView {
                VStack (spacing:5){
                    MyViewBuilder(title: Text("Кардиология"),
                                  content: Text("""
                                            ...
                                            **Классификация ИБС:**
                                            ...
                                            В диагнозе отмечают врачебные вмешательства и время их проведения: АКШ с указанием числа шунтов; стентирование с указанием сосудов, в которых проводилось вмешательство; баллонная контрапульсация; электрофизиологические вмешательства (временная или постоянная электрокардиостимуляция, абляция), дефибрилляция.
                    ...
                    MyViewBuilder(title: Text("Неврология"),
                                  content: Text("""
                    ...
                    MyViewBuilder(title: Text("Терапия и пульмонология"),
                                  content: Text("""
                    ...
                    MyViewBuilder(title: Text("Хирургия"),
                                  content: Text("""
                    ...
                    MyViewBuilder(title: Text("Гинекология"),
                                  content: Text("""
                    ...
                    MyViewBuilder(title: Text("Травматология"),
                                  content: Text("""
                    ...
                    MyViewBuilder(title: Text("Психиатрия"),
                                  content: Text("""
