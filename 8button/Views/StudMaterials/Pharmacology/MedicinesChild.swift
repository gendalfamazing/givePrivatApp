            ...
            ScrollView {
                VStack (spacing:5) {
                        ...
                        VStack(spacing: 1) {
                            ...
                            ForEach(TablePharmacology.getTablePharmacologyChild(), id: \.id) { name in
...
//            .edgesIgnoringSafeArea(.bottom)
        ...
        .toolbar {
            ToolbarItem(placement: .principal) {
                VStack {
                    Text("Применение ЛС у детей")
                        .font(.headline)
                        .foregroundStyle(Color.toolBar)
                        .bold()
                    Text("""
                    «Применении лекарственных препаратов у детей»
                    """)
                    .font(.caption2)
                    .foregroundStyle(Color.toolBar)
                }
