...
struct Prikaz1030Alg105View: View {
    ...
    var body: some View {
        NavigationStack {
            ScrollView {
                Spacer()
                VStack {
                    MyViewBuilder(title: Text("5"), content: Text("**Провести обследование**")).buildBlue1Text(isTextExpanded: isTextExpanded)
                        .onTapGesture {
                    ...
                    if isTextExpanded {
                        ...
                        **Клинические признаки:**
                        ...
                        HStack {
                        MyViewBuilder(title: Text("5"), content: Text("САД **меньше** 90 мм.рт.ст.")).buildGreen1Text(isTextExpanded: isTextExpanded4)
                            .onTapGesture {
                                withAnimation (.interpolatingSpring) {
                                    isTextExpanded4.toggle()
                                    if isTextExpanded5 == true {
                        ...
                        MyViewBuilder(title: Text("5"), content: Text("САД **больше** 90 мм.рт.ст.")).buildGreen1Text(isTextExpanded: isTextExpanded5)
                            .onTapGesture {
                                withAnimation (.interpolatingSpring) {
                                    isTextExpanded5.toggle()
                                    if isTextExpanded4 == true {
