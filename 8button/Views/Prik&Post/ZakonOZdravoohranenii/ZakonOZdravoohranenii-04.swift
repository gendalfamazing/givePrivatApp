            ...
            ScrollView {
                ...
                VStack (spacing: 5){
                    ZStack {
                        ...
                        VStack  {
                            MyViewBuilder(title: Text("Статья 14"), content: Text("Организация оказания медицинской помощи")).buildTitleZakon(isTextExpanded: isTextExpanded1)
                                .onTapGesture {
                    ...
                    ZStack {
                        MyViewBuilder(title: Text(""), content: Text("")).grayRectangle1()
                        VStack  {
                            MyViewBuilder(title: Text("Статья 15"), content: Text("Порядок оказания платных медицинских услуг гражданам Республики Беларусь государственными учреждениями здравоохранения")).buildTitleZakon(isTextExpanded: isTextExpanded2)
                                .onTapGesture {
                                    withAnimation (.snappy) {
                    ...
                    ZStack {
                        MyViewBuilder(title: Text(""), content: Text("")).grayRectangle1()
                        VStack  {
                            MyViewBuilder(title: Text("Статья 16"), content: Text("Виды медицинской помощи, формы и условия оказания медицинской помощи")).buildTitleZakon(isTextExpanded: isTextExpanded3)
                                .onTapGesture {
                                    withAnimation (.snappy) {
                    ...
                    ZStack {
                        MyViewBuilder(title: Text(""), content: Text("")).grayRectangle1()
                        VStack  {
                            MyViewBuilder(title: Text("Статья 17"), content: Text("Лечащий врач, врачебные консультации (консилиумы), врачебно-консультационные и иные комиссии")).buildTitleZakon(isTextExpanded: isTextExpanded4)
                                .onTapGesture {
                                    withAnimation (.snappy) {
                    ...
                    ZStack {
                        MyViewBuilder(title: Text(""), content: Text("")).grayRectangle1()
                        VStack  {
                            MyViewBuilder(title: Text("Статья 18"), content: Text("Методы оказания медицинской помощи")).buildTitleZakon(isTextExpanded: isTextExpanded5)
                                .onTapGesture {
                                    withAnimation (.snappy) {
                    ...
                    ZStack {
                        MyViewBuilder(title: Text(""), content: Text("")).grayRectangle1()
                        VStack  {
                            MyViewBuilder(title: Text("Статья 18¹"), content: Text("Медицинская профилактика")).buildTitleZakon(isTextExpanded: isTextExpanded6)
                                .onTapGesture {
                                    withAnimation (.snappy) {
                    ...
                    ZStack {
                        MyViewBuilder(title: Text(""), content: Text("")).grayRectangle1()
                        VStack  {
                            MyViewBuilder(title: Text("Статья 18²"), content: Text("Диспансеризация населения")).buildTitleZakon(isTextExpanded: isTextExpanded7)
                                .onTapGesture {
                                    withAnimation (.snappy) {
                    ...
                    ZStack {
                        MyViewBuilder(title: Text(""), content: Text("")).grayRectangle1()
                        VStack  {
                            MyViewBuilder(title: Text("Статья 18³"), content: Text("Оказание медицинской помощи пациентам с использованием биомедицинских клеточных продуктов")).buildTitleZakon(isTextExpanded: isTextExpanded8)
                                .onTapGesture {
                                    withAnimation (.snappy) {
                    ...
                    ZStack {
                        MyViewBuilder(title: Text(""), content: Text("")).grayRectangle1()
                        VStack  {
                            MyViewBuilder(title: Text("Статья 19"), content: Text("Изменение и коррекция половой принадлежности")).buildTitleZakon(isTextExpanded: isTextExpanded9)
                                .onTapGesture {
                                    withAnimation (.snappy) {
                    ...
                    ZStack {
                        MyViewBuilder(title: Text(""), content: Text("")).grayRectangle1()
                        VStack  {
                            MyViewBuilder(title: Text("Статья 20"), content: Text("Оказание медицинской помощи пациентам, находящимся в критическом для жизни состоянии")).buildTitleZakon(isTextExpanded: isTextExpanded10)
                                .onTapGesture {
                                    withAnimation (.snappy) {
                    ...
                    ZStack {
                        MyViewBuilder(title: Text(""), content: Text("")).grayRectangle1()
                        VStack  {
                            MyViewBuilder(title: Text("Статья 21"), content: Text("Основание для прекращения реанимационных мероприятий и мероприятий по поддержанию жизни пациента. Порядок констатации смерти")).buildTitleZakon(isTextExpanded: isTextExpanded11)
                                .onTapGesture {
                                    withAnimation (.snappy) {
