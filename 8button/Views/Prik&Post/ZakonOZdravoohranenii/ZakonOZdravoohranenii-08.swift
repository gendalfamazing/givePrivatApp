    ...
    var body: some View {
            ScrollView {
                ...
                VStack (spacing: 5){
                            ...
                            MyViewBuilder6(title: Text("Статья 37⁵"), content: Text("Информационное обеспечение в области здравоохранения"),
                            text: Text("""
                            ...
                            MyViewBuilder6(title: Text("Статья 37⁶"), content: Text("Централизованная информационная система здравоохранения"),
                            text: Text("""
                            ...
                            MyViewBuilder6(title: Text("Статья 37⁷"), content: Text("Оказание медицинской помощи, медицинское наблюдение и проведение медицинских экспертиз с применением телемедицинских технологий"),
                            text: Text("""
