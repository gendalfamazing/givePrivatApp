    ...
    var body: some View {
            ScrollView {
                ...
                VStack (spacing: 5){
                            ...
                            MyViewBuilder6(title: Text("Статья 13¹"), content: Text("Государственный социальный заказ в области здравоохранения"),
                            text: Text("""
                            ...
                            MyViewBuilder6(title: Text("Статья 13²"), content: Text("Государственный заказчик государственного социального заказа, финансируемого путем предоставления субсидий"),
                            text: Text("""
                            ...
                            MyViewBuilder6(title: Text("Статья 13³"), content: Text("Исполнители государственного социального заказа"),
                            text: Text("""
                            ...
                            MyViewBuilder6(title: Text("Статья 13⁵"), content: Text("Договор на выполнение государственного социального заказа, финансируемого путем предоставления субсидий"),
                            text: Text("""
                            ...
                            MyViewBuilder6(title: Text("Статья 13⁶"), content: Text("Контроль за реализацией государственного социального заказа, финансируемого путем предоставления субсидий, и расходованием финансовых средств, выделенных на его выполнение"),
                            text: Text("""
                            ...
                            MyViewBuilder6(title: Text("Статья 13⁷"), content: Text("Порядок разрешения споров и разногласий между государственным заказчиком и исполнителем государственного социального заказа"),
                            text: Text("""
