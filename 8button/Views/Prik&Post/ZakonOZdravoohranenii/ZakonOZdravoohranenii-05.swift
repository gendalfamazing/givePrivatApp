    ...
    var body: some View {
            ScrollView {
                ...
                VStack (spacing: 5){
                            ...
                            MyViewBuilder6(title: Text("Статья 22"), content: Text("Медицинская профилактика наследственных заболеваний у граждан Республики Беларусь"),
                            text: Text("""
                            ...
                            MyViewBuilder6(title: Text("Статья 23"), content: Text("Вспомогательные репродуктивные технологии"),
                            text: Text("""
                            ...
                            MyViewBuilder6(title: Text("Статья 24"), content: Text("Оказание медицинской помощи женщинам во время беременности, родов и в послеродовой период"),
                            text: Text("""
                            ...
                            MyViewBuilder6(title: Text("Статья 25"), content: Text("Особенности оказания медицинской помощи несовершеннолетним в стационарных условиях"),
                            text: Text("""
                            ...
                            MyViewBuilder6(title: Text("Статья 26"), content: Text("Стерилизация"),
                            text: Text("""
                            ...
                            MyViewBuilder6(title: Text("Статья 27"), content: Text("Искусственное прерывание беременности"),
                            text: Text("""
