    ...
    var body: some View {
            ScrollView {
                ...
                VStack (spacing: 5){
                            ...
                            MyViewBuilder6(title: Text("Статья 28"), content: Text("Особенности оказания медицинской помощи пациентам, имеющим заболевания, представляющие опасность для здоровья населения, вирус иммунодефицита человека"),
                            text: Text("""
                            ...
                            MyViewBuilder6(title: Text("Статья 29"), content: Text("Предупреждение пациентов о наличии у них венерических заболеваний и (или) вируса иммунодефицита человека"),
                            text: Text("""
                            ...
                            MyViewBuilder6(title: Text("Статья 30"), content: Text("Медицинская помощь пациентам, страдающим хроническим алкоголизмом, наркоманией и токсикоманией"),
                            text: Text("""
