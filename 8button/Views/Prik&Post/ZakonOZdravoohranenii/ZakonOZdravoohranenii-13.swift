            ...
            ScrollView {
                ...
                VStack (spacing: 5){
                    ZStack {
                        ...
                        VStack  {
                            MyViewBuilder(title: Text("Статья 63"), content: Text("Обязанность содействия медицинским работникам")).buildTitleZakon(isTextExpanded: isTextExpanded1)
                                .onTapGesture {
                    ...
                    ZStack {
                        MyViewBuilder(title: Text(""), content: Text("")).grayRectangle1()
                        VStack  {
                            MyViewBuilder(title: Text("Статья 63¹"), content: Text("Меры по охране здоровья населения")).buildTitleZakon(isTextExpanded: isTextExpanded2)
                                .onTapGesture {
                                    withAnimation (.snappy) {
                    ...
                    ZStack {
                        MyViewBuilder(title: Text(""), content: Text("")).grayRectangle1()
                        VStack  {
                            MyViewBuilder(title: Text("Статья 64"), content: Text("Возмещение организациям здравоохранения, другим организациям и индивидуальным предпринимателям расходов на оказание медицинской помощи")).buildTitleZakon(isTextExpanded: isTextExpanded3)
                                .onTapGesture {
                                    withAnimation (.snappy) {
                    ...
                    ZStack {
                        MyViewBuilder(title: Text(""), content: Text("")).grayRectangle1()
                        VStack  {
                            MyViewBuilder(title: Text("Статья 65"), content: Text("Ответственность за нарушение законодательства о здравоохранении")).buildTitleZakon(isTextExpanded: isTextExpanded4)
                                .onTapGesture {
                                    withAnimation (.snappy) {
