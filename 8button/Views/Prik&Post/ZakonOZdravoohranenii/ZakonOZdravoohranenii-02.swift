    ...
    var body: some View {
            ScrollView {
                ...
                VStack (spacing: 5){
                            ...
                            MyViewBuilder6(title: Text("Статья 8"), content: Text("Полномочия Президента Республики Беларусь, Совета Министров Республики Беларусь, других государственных органов и государственных организаций в области здравоохранения"),
                            text: Text("""
                            ...
                            MyViewBuilder6(title: Text("Статья 10"), content: Text("Структура здравоохранения Республики Беларусь"),
                            text: Text("""
                            ...
                            MyViewBuilder6(title: Text("Статья 11"), content: Text("Организации здравоохранения и особенности их создания. Порядок осуществления медицинской, фармацевтической деятельности негосударственными организациями здравоохранения и индивидуальными предпринимателями"),
                            text: Text("""
                            ...
                            MyViewBuilder6(title: Text("Статья 12"), content: Text("Лицензирование медицинской, фармацевтической деятельности"),
                            text: Text("""
                            ...
                            MyViewBuilder6(title: Text("Статья 12¹"), content: Text("Медицинская аккредитация государственных организаций здравоохранения"),
                            text: Text("""
                            ...
                            MyViewBuilder6(title: Text("Статья 13"), content: Text("Финансирование здравоохранения"),
                            text: Text("""
