...
struct Prikaz1030Alg76ViewFavorites: View {
    ...
    private var allViewIdentifiers: String = "Алгоритм 76. «Острая задержка мочи»"
    
    var body: some View {
        VStack {
            NavigationLink(destination: Prikaz1030Alg76View()) {
                HStack {
