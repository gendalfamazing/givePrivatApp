...
struct Prikaz1030Alg54ViewFavorites: View {
    ...
    private var allViewIdentifiers: String = "Алгоритм 54. «Острое психотическое возбуждение»"
    
    var body: some View {
        VStack {
            NavigationLink(destination: Prikaz1030Alg54View()) {
                HStack {
