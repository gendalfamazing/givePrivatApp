...
struct Prikaz1030Alg50ViewFavorites: View {
    ...
    private var allViewIdentifiers: String = "Алгоритм 50. «Аллергическая реакция»"
    
    var body: some View {
        VStack {
            NavigationLink(destination: Prikaz1030Alg50View()) {
                HStack {
