...
struct Prikaz1030Alg71ViewFavorites: View {
    ...
    private var allViewIdentifiers: String = "Алгоритм 71. «Кровотечение из уха»"
    
    var body: some View {
        VStack {
            NavigationLink(destination: Prikaz1030Alg71View()) {
                HStack {
