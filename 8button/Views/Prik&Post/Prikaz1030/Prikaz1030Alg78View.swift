...
struct Prikaz1030Alg78ViewFavorites: View {
    ...
    private var allViewIdentifiers: String = "Алгоритм 78. «Алкогольная интоксикация»"
    
    var body: some View {
        VStack {
            NavigationLink(destination: Prikaz1030Alg78View()) {
                HStack {
