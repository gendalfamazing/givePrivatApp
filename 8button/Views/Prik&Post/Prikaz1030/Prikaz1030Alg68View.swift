...
struct Prikaz1030Alg68ViewFavorites: View {
    ...
    private var allViewIdentifiers: String = "Алгоритм 68. «Заглоточный абсцесс»"
    
    var body: some View {
        VStack {
            NavigationLink(destination: Prikaz1030Alg68View()) {
                HStack {
