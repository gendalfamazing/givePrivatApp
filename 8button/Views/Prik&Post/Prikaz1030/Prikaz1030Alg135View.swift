...
struct Prikaz1030Alg35ViewFavorites: View {
    ...
    var isInFavorites: Bool {
        return favoritesManager.favorites.contains { $0.viewIdentifier == "Алгоритм 35. «Острый инфекционный гепатит»" }
    }
    
    func addToFavorites() {
        let newItem = FavoriteItem(name: "Приказ №1030", viewIdentifier: "Алгоритм 35. «Острый инфекционный гепатит»", isExpanded: false, isNavigationLink: true)
    ...
    func removeFromFavorites() {
        if let item = favoritesManager.favorites.first(where: { $0.viewIdentifier == "Алгоритм 35. «Острый инфекционный гепатит»" }) {
