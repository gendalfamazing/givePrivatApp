...
struct Prikaz1030Alg69ViewFavorites: View {
    ...
    private var allViewIdentifiers: String = "Алгоритм 69. «Кровотечение из глотки»"
    
    var body: some View {
        VStack {
            NavigationLink(destination: Prikaz1030Alg69View()) {
                HStack {
