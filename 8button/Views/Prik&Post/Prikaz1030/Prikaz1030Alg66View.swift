...
struct Prikaz1030Alg66ViewFavorites: View {
    ...
    private var allViewIdentifiers: String = "Алгоритм 66. «Травма половых органов (женщины)»"
    
    var body: some View {
        VStack {
            NavigationLink(destination: Prikaz1030Alg66View()) {
                HStack {
