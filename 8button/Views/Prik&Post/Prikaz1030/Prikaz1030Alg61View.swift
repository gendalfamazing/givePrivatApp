...
struct Prikaz1030Alg61ViewFavorites: View {
    ...
    private var allViewIdentifiers: String = "Алгоритм 61. «Странгуляционная асфиксия»"
    
    var body: some View {
        VStack {
            NavigationLink(destination: Prikaz1030Alg61View()) {
                HStack {
