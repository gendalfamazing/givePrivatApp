...
struct Prikaz1030Alg19ViewFavorites: View {
    ...
    var isInFavorites: Bool {
        return favoritesManager.favorites.contains { $0.viewIdentifier == "Алгоритм 19. «Расслаивающая аневризма аорты»" }
    }
    
    func addToFavorites() {
        let newItem = FavoriteItem(name: "Приказ №1030", viewIdentifier: "Алгоритм 19. «Расслаивающая аневризма аорты»", isExpanded: false, isNavigationLink: true)
    ...
    func removeFromFavorites() {
        if let item = favoritesManager.favorites.first(where: { $0.viewIdentifier == "Алгоритм 19. «Расслаивающая аневризма аорты»" }) {
