...
struct Prikaz1030Alg16View: View {
...
struct Prikaz1030Alg16ViewFavorites: View {
    ...
    var isInFavorites: Bool {
        return favoritesManager.favorites.contains { $0.viewIdentifier == "Алгоритм 16. «Кардиогенный шок»" }
    }
    
    func addToFavorites() {
        let newItem = FavoriteItem(name: "Приказ №1030", viewIdentifier: "Алгоритм 16. «Кардиогенный шок»", isExpanded: false, isNavigationLink: true)
    ...
    func removeFromFavorites() {
        if let item = favoritesManager.favorites.first(where: { $0.viewIdentifier == "Алгоритм 16. «Кардиогенный шок»" }) {
