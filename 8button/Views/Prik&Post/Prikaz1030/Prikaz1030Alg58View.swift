...
struct Prikaz1030Alg58ViewFavorites: View {
    ...
    private var allViewIdentifiers: String = "Алгоритм 58. «Длительное сдавление мягких тканей»"
    
    var body: some View {
        VStack {
            NavigationLink(destination: Prikaz1030Alg58View()) {
                HStack {
