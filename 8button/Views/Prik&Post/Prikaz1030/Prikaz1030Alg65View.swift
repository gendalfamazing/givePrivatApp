...
struct Prikaz1030Alg65ViewFavorites: View {
    ...
    private var allViewIdentifiers: String = "Алгоритм 65. «Кровотечение в послеродовом периоде»"
    
    var body: some View {
        VStack {
            NavigationLink(destination: Prikaz1030Alg65View()) {
                HStack {
