...
struct Prikaz1030Alg72ViewFavorites: View {
    ...
    private var allViewIdentifiers: String = "Алгоритм 72. «Ожоги и травмы глаза, века, конъюнктивы»"
    
    var body: some View {
        VStack {
            NavigationLink(destination: Prikaz1030Alg72View()) {
                HStack {
