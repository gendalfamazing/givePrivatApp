        ...
        NavigationStack {
            ScrollView {
                ...
                VStack(spacing: 0) {
                    ...
                    ScalesTablesFavorites()
                        .environment(\.viewContext, .nonFavorites)
                    
                    StudMaterialsFavorites()
                        .environment(\.viewContext, .nonFavorites)
                    
                    InfusionRateCalculatorViewFavorites()
                        .environment(\.viewContext, .nonFavorites)
                    
                    AkusherskoePosobieFavorites()
                        .environment(\.viewContext, .nonFavorites)
                    
                    AtlasECGFavorites()
                        .environment(\.viewContext, .nonFavorites)
                    
                    FastChildDosesFavorites()
                        .environment(\.viewContext, .nonFavorites)
...
struct ScalesTablesFavorites: View {
    @AppStorage("fontSize") var fontSize: Double = 14.0
    @EnvironmentObject var themeManager: ThemeManager
    @Environment(\.sizeCategory) var sizeCategory
...
struct StudMaterialsFavorites: View {
    @AppStorage("fontSize") var fontSize: Double = 14.0
    @EnvironmentObject var themeManager: ThemeManager
    @Environment(\.sizeCategory) var sizeCategory
...
struct InfusionRateCalculatorViewFavorites: View {
    @AppStorage("fontSize") var fontSize: Double = 14.0
    @EnvironmentObject var themeManager: ThemeManager
    @Environment(\.sizeCategory) var sizeCategory
...
struct AkusherskoePosobieFavorites: View {
    @AppStorage("fontSize") var fontSize: Double = 14.0
    @EnvironmentObject var themeManager: ThemeManager
    @Environment(\.sizeCategory) var sizeCategory
...
struct FastChildDosesFavorites: View {
    @AppStorage("fontSize") var fontSize: Double = 14.0
    @EnvironmentObject var themeManager: ThemeManager
    @Environment(\.sizeCategory) var sizeCategory
