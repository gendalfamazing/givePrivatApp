            ...
            ScrollView {
                VStack {
                    ...
                    ZStack {
                        ...
                        VStack  {
                            MyViewBuilder(title: Text("1"), content: Text("Общие положения")).buildBlue59Text(isTextExpanded: isTextExpanded)
                                .onTapGesture {
                            ...
                            if isTextExpanded{
                                MyViewBuilder(title: Text("3"), content: Text("""
                                        ...
                                        **Краткосрочные задачи (1–6 месяцев от начала лечения)**:
                                        - снижение САД и ДАД на 10% и более от исходных показателей или достижение целевого уровня АД;
                                        - предотвращение гипертонических кризов;
                                        - улучшение качества жизни;
                                        - модификация изменяемых факторов риска.
                                        
                                        **Промежуточные задачи (более 6 месяцев от начала лечения)**:
                                        - достижение целевого уровня АД,
                                        - профилактика поражения органов-мишеней или регрессия имеющихся осложнений,
                                        ...
                                        **Медикаментозная терапия артериальной гипертензии** должна осуществляться всем пациентам в соответствии с настоящим клиническим протоколом вне зависимости от уровня ее проведения.
                                        Эхокардиографическое обследование сердца, ультразвуковое исследование брахиоцефальных артерий, анализ мочи на микроальбуминурию следует проводить 1 раз в 2 года при отсутствии клинических проявлений со стороны поражения органов-мишеней.
