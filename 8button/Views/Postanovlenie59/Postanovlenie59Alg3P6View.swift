                    ...
                    if isTextExpanded10 {
                        ...
                        MyViewBuilder(title: Text("Алгоритм базовой СЛР"),
                                      content: Text("""
                                                    ...
                                                    2. **После проведения цикла из 30 компрессий грудной клетки выполнить2 вдоха** искусственного дыхания ** (соотношение 30 : 2 сохраняется на протяжении всех реанимационных мероприятий независимо от количества человек, оказывающих помощь).
